...
class Calculator:
    ...
    def __init__(self,master):
        ...
        self.entry = Entry(frame_s,textvariable=self.var,bg='yellow',width=45,bd=20,insertwidth=4,justify='right',font=('arial',10,'bold'))
        self.entry.pack()
        ...
        button_rbrace = Button(label_rbrace, text=')', font=('Helvetica', '16'), height=1, width=3,
                               command=lambda: self.click_button(')'),bg='blue',fg='blue')
        button_rbrace.pack()
